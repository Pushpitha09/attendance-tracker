...
export const addEvent = (data) => axios.post('http://localhost:5000/api/events/add', data);
export const deleteEvent = (id) => API.delete('/events/delete/' + id);
export const submitRSVP = (data) => API.post('/events/rsvp', data);
export const getRSVP = (eventId) => API.get('/events/rsvp/' + eventId);
export const getStudentRSVP = (eventId, studentId) => API.get('/events/rsvp/' + eventId + '/' + studentId);
